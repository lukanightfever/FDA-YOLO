...
class Detect(nn.Module):
    ...
    def convert(self, z):
        ...
        score = z[:, :, 6:]
        score *= conf
        convert_matrix = torch.tensor([[1, 0, 1, 0, 0], [0, 1, 0, 1, 0], [-0.5, 0, 0.5, 0, 0], [0, -0.5, 0, 0.5, 0], [0, 0, 0, 0, 1]],
...
class IDetect(nn.Module):
    ...
    def convert(self, z):
        ...
        score = z[:, :, 6:]
        score *= conf
        convert_matrix = torch.tensor([[1, 0, 1, 0, 0], [0, 1, 0, 1, 0], [-0.5, 0, 0.5, 0, 0], [0, -0.5, 0, 0.5, 0], [0, 0, 0, 0, 1.0]],
                                           dtype=torch.float32,
                                           device=z.device)
        box @= convert_matrix                          
        return (box, score)
...
class IAuxDetect(nn.Module):
    ...
    def forward(self, x):
        ...
        #return (torch.cat(z, 1), x[:self.nl])
        return x if self.training else (torch.cat(z, 1), x)
